...
class Camera():
    ...
    def startStreaming(self):
        ...
        #         while not self.stop_event.is_set():
        #             for frame in cam.get_frame_generator(limit=10, timeout_ms=100):
        #                 self.current_frame = frame.convert_pixel_format(opencv_display_format).as_opencv_image()
        #                 self.on_update(image_id, self.current_frame)
        #                 image_id += 1
